...
config :a2a_agent_web, A2aAgentWebWeb.Endpoint,
  ...
  render_errors: [
    formats: [json: A2aAgentWebWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: A2aAgentWeb.PubSub,
  live_view: [signing_salt: "aDOlt+Sd"]
...
config :a2a_agent_web, A2aAgentWeb.Mailer, adapter: Swoosh.Adapters.Local
